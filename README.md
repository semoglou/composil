...
- **Macro-average:** The per-cluster average silhouette score  
   (a detailed implementation of aggregation strategies can be found at [ipavlopoulos/revisiting-silhouette-aggregation](https://github.com/ipavlopoulos/revisiting-silhouette-aggregation)).
